...
list.of.packages <- c("shiny","shinyFiles","shinyTime","shinyWidgets","behavr","data.table","ggplot2",
                      ...
                      "scales","shinythemes","openxlsx",
                      "ActCR", "tools","nonlinearTseries","shinytitle",
                      "tidyverse")
...
shinyApp(
  ...
  server <- function(input, output,session){
    ...
    session$onSessionEnded(function() {
      # Clean up resources gracefully without forcing R to quit
      # The q("no") was causing R to crash on Mac
      tryCatch({
        stopApp()
      }, error = function(e) {
