                       ...
                       sidebarLayout(
                         mainPanel(
                           ...
                           fluidRow(style = "margin-top:10px",
                                    ...
                                    column(3,
                                           textInput("finish_time", "Finish Time",
                                                     value = "00:00", placeholder = "HH:MM")
                                    )),
                           ...
                           fluidRow( style = "margin-top:10px",
                                     column(1),
                                     column(3,
                                            textInput("zeitgeberTime", "Light onset time (ZT0)",
                                                      value = "08:00", placeholder = "HH:MM"),
                                            checkboxInput("applyZTToAll", "Apply to all files", value = TRUE)
                                     ),
